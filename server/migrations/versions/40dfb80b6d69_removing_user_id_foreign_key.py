"""removing user_id foreign key

Revision ID: 40dfb80b6d69
Revises: 
Create Date: 2023-08-29 14:06:49.138106
...
def downgrade():
    ...
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name='fk_users_user_id_users'),
